...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        guard let splitViewController = window?.rootViewController as? ProductSplitViewController,
              ...
              let masterViewController = masterNavController.viewControllers.first as? ProductMasterTableViewController,
              let detailViewController = detailNavController.viewControllers.last as? ProductDetailViewController
        else { fatalError() }
        masterViewController.delegate = detailViewController
        masterViewController.service = ProductSearchItemService()
